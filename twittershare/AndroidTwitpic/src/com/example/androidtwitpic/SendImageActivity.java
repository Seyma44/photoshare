...
builder.setTitle("Resim Seçiniz");
...
((TextView) findViewById(R.id.tv_user)).setText("Twitter Kullanıcı Adı: "+ username);
}
...
mProgressDialog = ProgressDialog.show(SendImageActivity.this, "", "Resim gönderiliyor...", true);
...
Log.d(TAG, "Resmi göndermeye başla...");

try {
url = upload.upload(new File(mPath));
result = 1;

Log.d(TAG, "Resim yüklendi, Twitpic url " + url);	
} catch (Exception e) {	
Log.e(TAG, "Resim gönderilemedi");
...
e.printStackTrace();
    ...
    protected void onPostExecute(Long result) {
     ...
     String text = (result == 1) ? "Resim başarıyla gönderildi.\n Twitpic url : " + url : "Failed to send image";
